    ...
    return (
        <div className="students-filter__form-part">
            ...
            <div className="students-filter__form-container">
                <p
                  className={`students-filter__form-option${isActive('Umowa o pracę')}`}
                  onClick={() => handleWorkPreferenceChange('Umowa o pracę')}
                >
                    Umowa o pracę
                </p>

                <p
                  className={`students-filter__form-option${isActive('B2B')}`}
                  onClick={() => handleWorkPreferenceChange('B2B')}
                >
                    B2B
                </p>

                <p
                  className={`students-filter__form-option${isActive('Umowa zlecenie')}`}
                  onClick={() => handleWorkPreferenceChange('Umowa zlecenie')}
                >
                    Umowa zlecenie
                </p>

                <p
                  className={`students-filter__form-option${isActive('Umowa o dzieło')}`}
                  onClick={() => handleWorkPreferenceChange('Umowa o dzieło')}
                >
                    Umowa o dzieło
                </p>
            </div>
